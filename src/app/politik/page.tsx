...
export default function Home() {
  return (
    <section className={styles.policy}>
      ...
      <p>
        Ihre Daten werden nur an Dritte übermittelt, wenn dies zur Erfüllung unserer vertraglichen Verpflichtungen oder
        auf Grundlage Ihrer Einwilligung erfolgt. Eine Weitergabe zu anderen Zwecken erfolgt nicht.
      </p>
